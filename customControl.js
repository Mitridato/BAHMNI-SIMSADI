...
angular.module('BirthCertificate', ['observationsService','appService','spinner'])
...
var EnvioOrdenes = angular.module('EnvioOrdenes', ['orderService','labOrders','pacsOrders'])
    .controller('EnvioOrdenes',['$scope', '$stateParams', 
        function ($scope, $stateParams) { 
            $scope.dashboardConfig = $scope.dashboard.getSectionByType("labOrders").dashboardConfig || {};
            $scope.dashboardConfig.patientUuid = $stateParams.patientUui
            $scope.dialogData = {
            ...
            return {
                templateUrl: "/home/mitridato/clinic-config/openmrs/apps/customDisplayControl/views/emailTemplate.html",
                scope: {
                    OrderSections: "=",
                    params: "=",
                    pacsOrders: "=",
